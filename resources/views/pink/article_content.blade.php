<div id="content-single" class="content group">
	...
	<div id="comments">
		...
		<div id="respond">
			<h3 id="reply-title">{{ Lang::get('ru.leave_a') }} <span>{{ Lang::get('ru.rep') }}</span> <small><a rel="nofollow" id="cancel-comment-reply-link" href="#respond" style="display:none;">{{ Lang::get('ru.cansel_reply') }}</a></small></h3>
			...
			@endif
				...
				<p class="comment-form-comment"><label for="comment">{{ Lang::get('ru.your_comment') }}</label><textarea id="comment" name="comment" cols="45" rows="8"></textarea></p>
				<div class="clear"></div>
				<p class="form-submit">
