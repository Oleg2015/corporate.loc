	...
	<div id="comment-{{ $item->id }}" class="comment-container">
		...
		<div class="comment-meta commentmetadata">
			...
			<div class="reply group">
				<a class="comment-reply-link" href="#respond" onclick="return addComment.moveForm(&quot;comment-{{ $item->id }}&quot;, &quot;{{ $item->id }}&quot;, &quot;respond&quot;, &quot;{{ $item->article->id }}&quot;)">{{ Lang::get('ru.reply_comment') }}</a>                    
			</div>
			<!-- .reply -->
		</div>
